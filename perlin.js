 ...
 * Converted to ES6 Class syntax by David Furlong.
 *
 * Version 2012-03-09
 *
...
export default class Noise {
  ...
  seed(seed) {
    ...
    if(seed < 256) {
      seed |= seed << 8; //EQUIVALENT TO seed = seed | (seed << 8)
    }
  ...
  perlin2(x, y) {
    ...
    // Compute the this.constructor.fade curve value for x
    var u = this.constructor.fade(x);
  ...
  perlin3(x, y, z) {
    ...
    // Compute the this.constructor.fade curve value for x, y, z
    var u = this.constructor.fade(x);
    var v = this.constructor.fade(y);
    var w = this.constructor.fade(z);
